...
const ShopWithSidebar = () => {
  ...
  // Transform categories for the dropdown component
  const transformedCategories = categories.map((category, index) => ({
    name: category.title,
    products: category.productCount || 0,
    isRefined: index === 0, // First category is selected by default
  }));
            ...
            >
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                  ...
                  {/* <!-- category box --> */}
                  <CategoryDropdown categories={transformedCategories} />
