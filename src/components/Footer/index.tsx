    ...
    <footer className="overflow-hidden">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Clifton Do Talwar The Plaza Shopping Mall Shop no 82,84, Karachi, Pakistan 75600
              </li>
              ...
              <li>
                <div className="flex items-center gap-4.5">
                  ...
                  <div className="flex flex-col leading-relaxed">
                    <Link href="tel:+923702539707" className="hover:underline">(+92) 370 2539707</Link>
                    <Link href="tel:+923102217007" className="hover:underline">(+92) 310 2217007</Link>
                    <Link href="tel:+923118811847" className="hover:underline">(+92) 311 8811847</Link>
                  </div>
                </div>
              </li>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-2 text-lg font-semibold text-dark uppercase tracking-wide lg:text-right">
              Follow Us
            </h2>
            <p className="text-gray-600 text-sm mb-4 lg:text-right">
            ...
            <ul className="flex flex-col gap-3 lg:items-end">
              ...
              <li>
                <a
                  href="https://www.facebook.com/nasirallfabric/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-[#1877F2] text-white py-2.5 px-4 rounded-lg shadow hover:bg-[#1563cc] transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path d="M22 12A10 10 0 1 0 10.5 22v-7H8v-3h2.5V9.5c0-2.5 1.5-3.9 3.7-3.9 1.1 0 2.2.2 2.2.2v2.4h-1.3c-1.3 0-1.7.8-1.7 1.6V12H18l-.4 3h-2.7v7A10 10 0 0 0 22 12z" />
                  </svg>
              ...
              <li>
                <a
                  href="https://www.instagram.com/nasir_all_fabrics/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-black py-2.5 px-4 rounded-lg shadow hover:opacity-90 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.66 0 3 1.34 3 3v10c0 1.66-1.34 3-3 3H7c-1.66 0-3-1.34-3-3V7c0-1.66 1.34-3 3-3h10zm-5 3.3A4.7 4.7 0 1 0 16.7 12 4.7 4.7 0 0 0 12 7.3zm0 7.7A3 3 0 1 1 15 12a3 3 0 0 1-3 3zm4.8-8.6a1 1 0 1 1-1.6-1.2 1 1 0 0 1 1.6 1.2z" />
                  </svg>
              ...
              <li>
                ...
                >
                  ...
                  <span className="font-medium text-sm pr-7">Tiktok</span>
                </a>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Nasir All Fabrics.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                {/* easy paisa */}
                <a href="#" aria-label="payment system with easy paisa">
                  <Image
